  ...
  return (
    ...
    <div className="flex h-dvh overflow-hidden [@media(display-mode:standalone)]:h-[var(--app-height,100vh)]">
      ...
      <div className="relative flex flex-1 flex-col overflow-hidden">
        ...
        />
        {/* Mobile bottom padding clears the fixed tab bar. Momentum +
            contained overscroll keep the inner scroll feeling native. */}
        <main className="flex-1 overflow-y-auto overscroll-y-contain bg-bg2 pb-[calc(72px+env(safe-area-inset-bottom))] [-webkit-overflow-scrolling:touch] md:pb-0">
          {children}
        </main>
        <MobileNav />
        <SidekickDock />
