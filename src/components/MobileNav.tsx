...
export default function MobileNav() {
  ...
  return (
    <div className="relative shrink-0 md:hidden">
      <nav
        className="scrollbar-none mx-3 mb-[max(6px,calc(env(safe-area-inset-bottom)-12px))] mt-1.5 flex items-center overflow-x-auto rounded-full border border-border2 bg-background/90 px-1.5 py-1.5 shadow-[0_10px_30px_rgba(0,0,0,0.35)] backdrop-blur"
        aria-label="Primary"
      >
        {ITEMS.map((item) => {
