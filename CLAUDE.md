...
- Database: schema + RLS in `supabase/migrations/` (0001 init, 0002 import ext_id, 0003 notes, 0004 traded_on -> timestamptz + commission, 0005 chart_analyses, 0006 pair tags on notes/strategies). Apply 0004 before MT5 import, 0006 before tagging notes/strategies with pairs.
